...
public class programming extends HttpServlet {
    /**
	 * 
	 */
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        request.setAttribute("ztitle", "Programming");
        ...
        request.setAttribute("zcontent", GetPage.getContent("programming",configUrl, configUser, configPass));
